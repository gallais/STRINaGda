...
Because our \AF{induction} function has the right computational behaviour,
...
any surprise that the fact that \AF{zero} is trivially a left neutral for
...
work. We can use \AF{induction} itself to build such a proof.
...
The proof of the statement relating the addition of \AB{m} to \AF{suc} \AB{n}
